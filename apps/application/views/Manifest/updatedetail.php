...
<div class="chart-box">
    <div class="row">
        <form action="<?= base_url('ManifestController/updatedetail/'.$id.'/'.$data->id_manifest); ?>" method="POST">
            ...
            <div class="col-md-12">
                <div class="form-group has-feedback">
                    ...
                    <textarea class="form-control" required="" name="status"><?=$data->status?></textarea>
                </div>
            </div>
